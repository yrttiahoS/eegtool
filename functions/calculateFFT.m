...
% Calculates FFT for all the events (average TFRs across the 3rd dimension
% of the EEG matrix)
%
% Parameters:
%  data       = matrix [channels datapoints events] (EEGLAB epoched EEG-struct .data)
%  srate      = sampling rate
...
% form windowing-matrix for the multiplication (window length is the amount of datapoints
% before zero)
if wind == 0
