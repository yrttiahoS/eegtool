function saveRejectionInfo(dpath, fname, stimid, rejepochs, urev_val)
    % Save information of manual rejections to a file. Each time this 
    % function is called it appends the information to the end of the file
    % or starts a new one with column headers if no file exists.
    %
    % Parameters:
    ...
    %  urev_val  = original event validity of that participant/stimulus
    %              [nchan nepoch]
